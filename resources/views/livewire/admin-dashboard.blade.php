<div class="grid w-full gap-8 p-8 mx-auto xl:p-8 2xl:p-10 xl:gap-8 2xl:gap-10">
    ...
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 xl:gap-8 2xl:gap-10">
        <x-board color="blue-500" name="total users" digit="{{ \App\Models\User::count() - 1 }}">
        ...
        <x-board color="red-500" name="Books" digit="{{ \App\Models\User::count() }}">
        ...
        <x-board color="green-600" name="sales" money="{{ true }}" digit="{{ moneyFormat(random_int(50000, 1000000)) }}">
        ...
        <x-board color="gray-500" name="performance" digit="{{ performance(random_int(50000, 1000000), random_int(50000, 1000000)) }}">
