    ...
    <tbody class="w-full overflow-x-auto break-normal">
      ...
      <tr class="">
        <td class="p-2 whitespace-nowrap">
          <input type="checkbox" wire:model="checked" id="" value="{{ $user->id }}"
        ...
        <td class="p-2 whitespace-nowrap">
          <div class="flex space-x-2 item-center">
            {{-- <a href="tel:+234{{ str_replace('-', '', $user->phone) }}" class="w-8 h-8 p-2 text-green-600 border
            border-green-600 rounded tt hover:-translate-y-1">
            ...
            {{-- <span wire:click="edit({{ $user->id }})" class="w-8 h-8 p-2 text-blue-600 border border-blue-600
            rounded-md cursor-pointer tt hover:-translate-y-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="my-auto bi bi-eye"
              viewBox="0 0 16 16">
              <path
            ...
            <span wire:click="confirmDelete({{ $user->id }})"
