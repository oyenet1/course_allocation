                        ...
                        <a class="navbar-link">
                            <div class="user-avatar">
                                <img src="https://avatars.dicebear.com/v2/initials/john-doe.svg"
                                    alt="{{ currentUser()->name }}" class="rounded-full" />
                            </div>
            ...
            <div class="space-y-1 overflow-y-auto menu is-menu-main">
                ...
                <ul class="space-y-1 menu-list">
                    <li>
                        ...
                        <ul class="bg-white ">
                            <li
                                class=" {{ request()->is('admin/users') ? 'bg-primary-200  border-l-4 border-white' : 'bg-white' }}">
                ...
                <ul class="space-y-1 menu-list">
                    <li>
                        <a class="dropdown {{ request()->is('admin/books') ? 'active' : '' }}"
                            href="{{ route('books') }}">
                            <span class="icon">
                                <svg style="width:20px;height:20px" viewBox="0 0 24 24">
                                    <path fill="currentColor"
