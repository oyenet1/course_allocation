  ...
  <table class="w-full space-y-2 overflow-x-auto whitespace-nowrap">
    ...
    <tbody class="w-full overflow-x-auto break-normal">
      ...
      <tr class="">
        ...
        <td class="p-2 whitespace-nowrap">
          <p class=""><?php echo e($user->first_name . ' '. $user->last_name); ?></p>
        </td>
        <td class="p-2 whitespace-nowrap">
        ...
        <td class="p-2 whitespace-nowrap">
          <div class="flex space-x-2 item-center">
            <a href="tel:+234<?php echo e(str_replace('-', '', $user->phone)); ?>" class="w-8 h-8 p-2 text-green-600 border border-green-600 rounded tt hover:-translate-y-1">
            ...
            <span wire:click="edit(<?php echo e($user->id); ?>)" class="w-8 h-8 p-2 text-blue-600 border border-blue-600 rounded-md cursor-pointer tt hover:-translate-y-1">
            ...
            <span wire:click="confirmDelete(<?php echo e($user->id); ?>)" class="w-8 h-8 p-2 text-red-600 border border-red-600 rounded-md cursor-pointer tt hover:-translate-y-1">
...
<?php /**PATH /Users/user/Documents/projects/course_allocation/resources/views/livewire/users.blade.php ENDPATH**/ ?>