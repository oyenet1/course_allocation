    ...
    */
    'middleware' => [
        ...
        'handlers' => [
            ...
            'abort' => [
                'code' => 403,
                'message' => 'You does not have any of the necessary access rights to the page you want to visits.'
            ],
            ...
            'redirect' => [
                ...
                'message' => [
                    'key' => 'error',
                    'content' => 'You does not have any of the necessary access rights to the page you want to visits.'
                ]
            ]
        ]
    ],
